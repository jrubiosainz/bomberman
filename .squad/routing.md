...
|-----------|----------|----------|
| Game mechanics | McManus | Bomb placement, explosions, movement, collision, powerups, AI |
| Rendering & UI | Fenster | Canvas rendering, sprites, animations, cartoon style, menus, HUD |
| Architecture & design | Keaton | Game loop design, state management, level format, component structure |
| Code review | Keaton | Review PRs, check quality, suggest improvements |
| Testing | Hockney | Write tests, find edge cases, gameplay balance, verify fixes |
